...
function Movies({type, filterByGenre, filterByName}) {
      ...
      useEffect(() => {
        const fetchMovies = async () => {
          ...
          if(filterByGenre !== ""){
            ...
            url = `https://api.themoviedb.org/3/search/movie?api_key=${process.env.REACT_APP_API_KEY}&language&language=en-US&query=${filterByName}&page=${currentPage}&include_adult=false`
          }
